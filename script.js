...
const bookings = [
  ...
  { name: 'Madhava Rao Murari', area: '', slot: '6:00 PM – 7:00 PM', pandit: 'Sadashiv Naganure' },
  { name: 'Shweta Iyer', area: 'Chembur', slot: '6:00 PM – 7:00 PM', pandit: 'Dev Ranjan Das' },
  { name: 'Anju Bareja', area: '', slot: '5:00 PM – 6:00 PM', pandit: 'Seema Wadhwa' },
  { name: 'Devraj Lalla', area: '', slot: '4:00 PM – 5:00 PM', pandit: 'Madhuri Bhatia' },
  { name: 'Madhavi Rajput', area: 'Govandi', slot: '10:00 AM – 11:00 AM', pandit: 'Karuna Patil' },
  { name: 'Haresh Hiranandani', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Mahi Hiranandani' },
  { name: 'Seema wadhwa', area: '', slot: '1:00 PM – 2:00 PM', pandit: 'Seema Wadhwa' },
  { name: 'Rashmi vidya', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Anchal Gupta' },
  { name: 'Roshni Khanna', area: '', slot: '8:00 PM – 9:00 PM', pandit: 'Mahi Hiranandani' },
  { name: 'Meeta Gangwani', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Meeta' },
  { name: 'vaishali Padarkar', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Meeta' },
  { name: 'Vasihali Gonarkar', area: '', slot: '4:00 PM – 5:00 PM', pandit: 'Vaishali Gonarkar' },
  { name: 'Rajeev Narang', area: '', slot: '4:30 PM – 5:30 PM', pandit: 'Vaishali Gonarkar' },
  { name: 'Mr G Singh', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Dr. Rajni Singh' },
  { name: 'Jyoti Gupta', area: '', slot: '4:00 PM – 5:00 PM', pandit: 'Dev Ranjan Das' },
  { name: 'Saumitra trivedi', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Saumitra trivedi' },
  { name: 'shweta Tharani', area: 'Anushaktinagar', slot: '4:00 PM – 5:00 PM', pandit: 'Saumitra trivedi' },
  { name: 'Neema Kamdar', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Neema Kamdar' },
  { name: 'Jaya Satumane', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Jaya Satumane' },
  ...
  { name: 'Jyoti Patil', area: '', slot: '5:00 PM – 6:00 PM', pandit: 'Kavita Kejriwal' },
  ...
  { name: 'Ritu Lokhandwala', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Ritu Lokhandwala' },
  { name: 'Mala Bhojwani', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Mala Bhojwani' },
  { name: 'Sonia Bhojwani', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Sonia Bhojwani' },
  { name: 'Surekha Shetty 2', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Surekha Shetty' },
  { name: 'Followup - Shishode garden', area: '', slot: '7:00 AM – 8:00 AM', pandit: 'sandip indap' },
  { name: 'Sandip Indap', area: '', slot: '', pandit: 'sandip indap' },
  { name: 'Radha', area: '', slot: '2:30 PM – 3:30 PM', pandit: 'Vijayalakshmi Chellam' },
  { name: 'South Mumbai 1', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Radhika Kopikar' },
  { name: 'South Mumbai 2', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Radhika Kopikar' },
  { name: 'South Mumbai 3', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Radhika Kopikar' },
  { name: 'South Mumbai 4', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Radhika Kopikar' },
  { name: 'South Mumbai 5', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Radhika Kopikar' },
  { name: 'Chaitali', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Shanthi Narayan' },
  { name: 'sambhaji Shop', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Preeta Sehgal' },
  { name: 'Sambhaji House', area: '', slot: '10:00 AM – 11:00 AM', pandit: 'Preeta Sehgal' },
  { name: 'Nilay Jasu', area: '', slot: '', pandit: 'Nilay Jasu' },
  { name: 'Devendra Keny', area: '', slot: '', pandit: 'Devendra Keny' },
  { name: 'Shanti Subramanuim', area: '', slot: '', pandit: 'Shanti Subramanium' },
  { name: 'Jairaj Mothers', area: '', slot: '', pandit: 'Seema Wadhwa' },
  { name: 'Pranjali Kulkarni', area: '', slot: '4:00 PM – 5:00 PM', pandit: 'Radhika Chandle' },
];
